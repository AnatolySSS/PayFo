...
export class PaymentFu {
  ...
  constructor(id, fu, type, date, number, app_date, order, pay_date, in_force_date, last_day_for_pay_date,
    ...
    if (this.suspension_type.options.selectedIndex == 1) {
      ...
      Решения Суда, за вычетом количества дней с момента вступления в силу Решения финансового уполномоченного 
      от ${this.getDateFormatted()} и до даты приостановления срока исполнения Решения финансового уполномоченного 
